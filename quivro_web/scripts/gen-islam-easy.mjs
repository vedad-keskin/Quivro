...
const raw = [
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Collection of hadith only', bs: 'Samo zbirka hadisa' },
      { en: 'History of kings', bs: 'Historija vladara' },
      { en: 'Arabic grammar alone', bs: 'Samo arapska gramatika' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      { en: 'Ta\'wil', bs: 'Te\'vil' },
      { en: 'Balagha only', bs: 'Samo belaga' },
      { en: 'Sarf only', bs: 'Samo sarf' },
      { en: 'Usul only', bs: 'Samo usul' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'A surah revealed only in Medina', bs: 'Sura objavljena samo u Medini' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'King of this world only', bs: 'Kralj samo ovog svijeta' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Trade regulations only', bs: 'Samo trgovačka pravila' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only poetry', bs: 'Samo poezija' },
      { en: 'Only military strategy', bs: 'Samo vojna strategija' },
    ],
    correctIndex: 0,
  },
  {
  ...
  {
    prompt: {
      en: 'The hadith about rights teaches balance among Allah, yourself, and:',
      bs: 'Hadis o pravima uči ravnoteži između Allaha, sebe i:',
    },
    options: [
      { en: 'Your family', bs: 'Tvoje porodice' },
      { en: 'Only rulers', bs: 'Samo vladara' },
      { en: 'Only neighbors', bs: 'Samo komšija' },
      { en: 'Nobody else', bs: 'Nikoga drugog' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Arabs only', bs: 'Samo Arapima' },
      { en: 'Men only', bs: 'Samo muškarcima' },
      { en: 'Medina residents only', bs: 'Samo stanovnicima Medine' },
    ],
    correctIndex: 0,
  },
  {
  ...
  {
    prompt: {
      en: 'Which pillar of Islam is fasting during Ramadan?',
      bs: 'Koji stub islama je post u mjesecu ramazanu?',
    },
    options: [
      { en: 'The fourth pillar', bs: 'Četvrti stub' },
      { en: 'The first pillar', bs: 'Prvi stub' },
      { en: 'The fifth pillar', bs: 'Peti stub' },
      { en: 'Not a pillar of Islam', bs: 'Nije stub islama' },
    ],
    correctIndex: 0,
  },
  {
    prompt: {
      en: 'What does a Muslim testify in the shahada?',
      bs: 'U šehadetu musliman svjedoči da:',
    },
    options: [
      { en: 'There is no god but Allah and Muhammad is His Messenger', bs: 'Nema boga osim Allaha i da je Muhammed Njegov poslanik' },
      { en: 'Angels are partners in lordship', bs: 'Meleki su partneri u gospodarenju' },
      { en: 'Only the Qur\'an matters, not the Prophet', bs: 'Samo Kur\'an vrijedi, ne i Poslanik' },
      { en: 'Prayer alone is sufficient', bs: 'Samo namaz je dovoljan' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Al-hadith, al-fiqh only', bs: 'Samo el-hadis, el-fikh' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Astronomy only', bs: 'Samo astronomija' },
      { en: 'Medicine only', bs: 'Samo medicina' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only if recited silently', bs: 'Samo ako se čita tiho' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Foreign philosophy only', bs: 'Samo strana filozofija' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'A road in Mecca only', bs: 'Samo put u Meki' },
      { en: 'Any path one prefers', bs: 'Bilo koji put po želji' },
      { en: 'Only scholars, not prophets', bs: 'Samo učenjake, ne poslanike' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Silence and isolation only', bs: 'Samo šutnja i izolacija' },
      { en: 'Poetry and art only', bs: 'Samo poezija i umjetnost' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only themselves', bs: 'Samo sebi' },
      { en: 'Only rulers', bs: 'Samo vladarima' },
      { en: 'Only animals, not humans', bs: 'Samo životinjama, ne ljudima' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Longest beard only', bs: 'Samo najdužom bradom' },
  ...
  },
  {
    ...
    options: [
      { en: 'No inherent evil—evil exists only in what occurs', bs: 'Ne sadrži zlo po sebi—zlo je u onome što se dogodi' },
      ...
      { en: 'Only punishment, never mercy', bs: 'Samo kaznu, nikad milost' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Only the Psalms count', bs: 'Vrijede samo Zeburi' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Symbolic judgment only', bs: 'Samo simbolički sud' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Tacit approval only', bs: 'Samo prešutnog odobrenja' },
      { en: 'Physical description only', bs: 'Samo fizičkog opisa' },
      { en: 'Companion statement only', bs: 'Samo izjave ashaba' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only for travelers', bs: 'Samo za putnike' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Physical strength only', bs: 'Samo fizička snaga' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Collector of Qur\'an alone', bs: 'Samo sakupilac Kur\'ana' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Persia only', bs: 'Samo Perziji' },
      { en: 'Abyssinia only', bs: 'Samo Abesiniji' },
      { en: 'India', bs: 'Indiji' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      { en: 'Quba', bs: 'Kubi' },
      { en: 'Jerusalem only', bs: 'Samo Jerusalimu' },
      { en: 'Taif', bs: 'Taifu' },
      { en: 'Basra', bs: 'Basri' },
    ],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Hajj only', bs: 'Samo hadža' },
      { en: 'Zakat payment only', bs: 'Samo davanja zekata' },
