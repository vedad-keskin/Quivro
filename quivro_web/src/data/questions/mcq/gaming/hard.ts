...
export const gamingHard: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'In graphics, "anti-aliasing" reduces…',
      bs: 'U grafici, "anti-aliasing" smanjuje…',
    },
    options: [
      { en: 'Loading screen time', bs: 'Vrijeme loading screena' },
      { en: 'Ping spike frequency', bs: 'Frekvenciju ping spikeova' },
      { en: 'Audio clipping noise', bs: 'Audio clipping šum' },
      { en: 'Jagged edge artifacts', bs: 'Zube na rubovima' },
    ],
    correctIndex: 3,
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'In level design, a "nav mesh" guides…',
      bs: 'U level dizajnu, "nav mesh" vodi…',
    },
    options: [
      { en: 'AI pathfinding', bs: 'AI pathfinding' },
      { en: 'Shader baking', bs: 'Shader baking' },
      { en: 'Save compression', bs: 'Save kompresiju' },
      { en: 'Menu scrolling', bs: 'Menu scrolling' },
    ],
    correctIndex: 0,
  },
  {
    ...
    category: 'gaming',
    difficulty: 'hard',
    prompt: { en: 'In fighting games, "hitstun" is…', bs: 'U fighting igrama, "hitstun" je…' },
    options: [
      { en: 'Bonus damage scaling', bs: 'Skaliranje bonus štete' },
      { en: 'Post-hit recovery frames', bs: 'Frameovi oporavka poslije udarca' },
      { en: 'Healing over time', bs: 'Liječenje tokom vremena' },
      { en: 'Map rotation timer', bs: 'Timer rotacije mape' },
    ],
    correctIndex: 1,
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'In shooters, "hit registration" decides if…',
      bs: 'U shooterima, "hit registration" odlučuje da li…',
    },
    options: [
      { en: 'Skins unlock early', bs: 'Skins se rano otključavaju' },
      { en: 'Ranks reset weekly', bs: 'Rankovi se resetuju sedmično' },
      { en: 'Shots count as hits', bs: 'Pucnjevi broje kao pogoci' },
      { en: 'Maps rotate hourly', bs: 'Mape se rotiraju na sat' },
    ],
    correctIndex: 2,
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Which console is historically the best-selling of all time?',
      bs: 'Koja je konzola historijski najprodavanija ikada?',
    },
    options: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'MSX computers were especially influential for gaming in…',
      bs: 'MSX računari su bili posebno uticajni za gaming u…',
    },
    options: [
      { en: 'North Africa', bs: 'Sjevernoj Africi' },
      { en: 'Japan and Europe', bs: 'Japanu i Evropi' },
      { en: 'Central Antarctica', bs: 'Centralnoj Antarktici' },
      { en: 'South Pacific only', bs: 'Samo južnom Pacifiku' },
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      { en: 'Chat command', bs: 'Chat komanda' },
      { en: 'Shop discount', bs: 'Shop popust' },
      { en: 'Map boss monster', bs: 'Map boss čudovište' },
      { en: 'Ping sound effect', bs: 'Ping sound efekt' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'In roguelikes, "permadeath" means characters die…',
      bs: 'U roguelike igrama, "permadeath" znači da likovi umiru…',
    },
    options: [
      { en: 'Temporarily', bs: 'Privremeno' },
      { en: 'Visually only', bs: 'Samo vizuelno' },
      { en: 'Permanently', bs: 'Trajno' },
      { en: 'Randomly each frame', bs: 'Nasumično svaki frame' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'IEM Katowice became iconic primarily for hosting which esport finals?',
      bs: 'IEM Katowice je postao ikoničan prvenstveno kao domaćin finala u kojem esportu?',
    },
    options: [
      { en: 'Counter-Strike', bs: 'Counter-Strike' },
      { en: 'Chess boxing', bs: 'Chess boxingu' },
      { en: 'Farming Simulator', bs: 'Farming Simulatoru' },
      { en: 'Guitar Hero', bs: 'Guitar Hero' },
    ],
    correctIndex: 0,
  },
  {
