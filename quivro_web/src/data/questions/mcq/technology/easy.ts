...
export const technologyEasy: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'easy',
    prompt: {
      en: 'In The Last of Us, what caused the outbreak that devastated humanity?',
      bs: 'U serijalu The Last of Us, šta je izazvalo epidemiju koja je uništila čovječanstvo?',
    },
    options: [
      { en: 'A mutated Cordyceps fungus', bs: 'Mutirani kodriceps' },
      { en: 'A zombie virus from space', bs: 'Zombi virus iz svemira' },
      { en: 'A nuclear explosion', bs: 'Nuklearna eksplozija' },
      { en: 'A failed artificial intelligence experiment', bs: 'Neuspjeli eksperiment umjetne inteligencije' },
    ],
    correctIndex: 0,
  },
  {
