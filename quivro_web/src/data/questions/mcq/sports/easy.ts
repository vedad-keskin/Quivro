...
export const sportsEasy: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'easy',
    prompt: {
      en: 'A slam dunk is scored when a player puts the ball through the…',
      bs: 'Slam dunk se postiže kada igrač ubaci loptu kroz…',
    },
    options: [
      { en: 'Basketball hoop', bs: 'Košarkaški obruč' },
      { en: 'Free throw line', bs: 'Liniju slobodnih bacanja' },
      { en: 'Three-point arc', bs: 'Liniju za tri poena' },
      { en: 'Backboard support', bs: 'Nosač table' },
    ],
    correctIndex: 0,
  },
  {
