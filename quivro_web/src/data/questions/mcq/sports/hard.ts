...
export const sportsHard: Question[] = [
  ...
  },
  {
    ...
    category: 'sports',
    difficulty: 'hard',
    prompt: { en: 'Which Greek national team shocked Europe by winning UEFA Euro 2004?', bs: 'Koja grčka reprezentacija je šokirala Evropu osvajanjem Eura 2004.?' },
    options: [
      { en: 'Portugal', bs: 'Portugal' },
      { en: 'Greece', bs: 'Grčka' },
  ...
  },
  {
    ...
    category: 'sports',
    difficulty: 'hard',
    prompt: { en: 'Which Hungarian football team of the 1950s was nicknamed the “Mighty Magyars”?', bs: 'Koji mađarski fudbalski tim 1950-ih je imao nadimak „Mighty Magyars“?' },
    options: [
      { en: 'Hungary national team', bs: 'Mađarska reprezentacija' },
      { en: 'Ferencváros only', bs: 'Samo Ferencváros' },
      { en: 'Austria', bs: 'Austrija' },
      { en: 'Czechoslovakia', bs: 'Čehoslovačka' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'A 4-4-2 midfield press only', bs: 'Samo 4-4-2 pressing u veznom redu' },
  ...
  },
  {
    ...
    category: 'sports',
    difficulty: 'hard',
    prompt: { en: 'Which Olympics were boycotted by the United States and many allies in 1980?', bs: 'Koje Olimpijske igre su bojkotovale Sjedinjene Američke Države i mnogi saveznici 1980.?' },
    options: [
  ...
  },
  {
    ...
    category: 'sports',
    difficulty: 'hard',
    prompt: { en: 'Which Olympics did the Soviet Union and Eastern Bloc boycott in 1984?', bs: 'Koje Olimpijske igre su Sovjetski Savez i Istočni blok bojkotovali 1984.?' },
    options: [
      { en: 'Moscow 1980', bs: 'Moskva 1980.' },
      { en: 'Los Angeles 1984', bs: 'Los Anđeles 1984.' },
      { en: 'Seoul 1988', bs: 'Seul 1988.' },
  ...
  },
  {
    ...
    category: 'sports',
    difficulty: 'hard',
    prompt: { en: 'Which 1972 chess match between Fischer and Spassky was called the “Match of the Century”?', bs: 'Koji šahovski meč 1972. između Fischera i Spaskog je nazvan „Meč stoljeća“?' },
    options: [
      { en: 'Moscow', bs: 'Moskva' },
