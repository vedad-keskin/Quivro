...
export const famousHard: Question[] = [
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Florence Nightingale helped establish modern…',
      bs: 'Florence Nightingale je pomogla uspostaviti moderno…',
    },
    options: [
      { en: 'Banking', bs: 'Bankarstvo' },
      { en: 'Nursing', bs: 'Medicinsko sestrinstvo' },
      { en: 'Publishing', bs: 'Izdavaštvo' },
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Amelia Earhart was a pioneering figure in…',
      bs: 'Amelia Earhart bila je pionir u…',
    },
    options: [
      { en: 'Marine biology', bs: 'Morskoj biologiji' },
      { en: 'Fashion design', bs: 'Modnom dizajnu' },
      { en: 'Classical music', bs: 'Klasičnoj muzici' },
      { en: 'Aviation', bs: 'Avijaciji' },
    ],
    correctIndex: 3,
  },
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Sojourner Truth delivered the landmark speech…',
      bs: 'Sojourner Truth je održala znameniti govor…',
    },
    options: [
      { en: 'I Have a Dream', bs: 'I Have a Dream' },
      { en: "Ain't I a Woman?", bs: "Ain't I a Woman?" },
      { en: 'Blood, Toil, Tears and Sweat', bs: 'Blood, Toil, Tears and Sweat' },
      { en: 'The Gettysburg Address', bs: 'Gettysburg Address' },
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Paul Ehrlich pioneered early treatment concepts later called…',
      bs: 'Paul Ehrlich je pionirski razvio rane koncepte liječenja kasnije nazvane…',
    },
    options: [
      { en: 'Chemotherapy', bs: 'Hemoterapija' },
      { en: 'Radiotherapy', bs: 'Radioterapija' },
      { en: 'Physiotherapy', bs: 'Fizioterapija' },
      { en: 'Homeopathy', bs: 'Homeopatija' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Elizabeth Blackwell became the first woman to earn a medical degree in the…',
      bs: 'Elizabeth Blackwell je postala prva žena koja je stekla medicinski diplom u…',
    },
    options: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Bayard Rustin was a chief organizer of the…',
      bs: 'Bayard Rustin je bio glavni organizator…',
    },
    options: [
      { en: 'Seneca Falls Convention', bs: 'Seneca Falls konvencije' },
      { en: 'Haymarket rally', bs: 'Haymarket skupa' },
      { en: 'Scopes trial', bs: 'Scopes suđenja' },
      { en: '1963 March on Washington', bs: 'Marša na Washington 1963.' },
    ],
    correctIndex: 3,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: "Olaudah Equiano's autobiography advanced the cause of…",
      bs: 'Olaudah Equiano-ova autobiografija je unaprijedila borbu za…',
    },
    options: [
      { en: "Women's suffrage", bs: 'Žensko biračko pravo' },
      { en: 'Free trade', bs: 'Slobodnu trgovinu' },
      { en: 'Abolition of slavery', bs: 'Ukidanje ropstva' },
      { en: 'Colonial expansion', bs: 'Kolonialnu ekspanziju' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Susan B. Anthony campaigned tirelessly for…',
      bs: 'Susan B. Anthony je neumorno zagovarala…',
    },
    options: [
      { en: "Women's suffrage", bs: 'Žensko biračko pravo' },
      { en: 'Colonial tariffs', bs: 'Kolonialne carine' },
      { en: 'Naval expansion', bs: 'Pomorsku ekspanziju' },
      { en: 'Postal reform', bs: 'Poštansku reformu' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'William Harvey demonstrated the circulation of…',
      bs: 'William Harvey je dokazao cirkulaciju…',
    },
    options: [
      { en: 'Lymph only', bs: 'Samo limfe' },
      { en: 'Digestive enzymes', bs: 'Digestivnih enzima' },
      { en: 'Blood', bs: 'Krvi' },
      { en: 'Cerebrospinal fluid', bs: 'Cerebrospinalne tečnosti' },
    ],
    correctIndex: 2,
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Antonie van Leeuwenhoek pioneered microscopy of…',
      bs: 'Antonie van Leeuwenhoek je pionirski koristio mikroskopiju za…',
    },
    options: [
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Mary Leakey uncovered fossil footprints at…',
      bs: 'Mary Leakey je otkrila fosilne otiske stopala u…',
    },
    options: [
      { en: 'Laetoli', bs: 'Laetoliju' },
      { en: 'Olduvai only', bs: 'samo Olduvaiju' },
      { en: 'Lascaux caves', bs: 'Lascaux pećinama' },
      { en: 'Stonehenge', bs: 'Stonehengeu' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Arthur Evans uncovered the palace complex at…',
      bs: 'Arthur Evans je otkrio dvorski kompleks u…',
    },
    options: [
      { en: 'Persepolis', bs: 'Persepolisu' },
      { en: 'Petra', bs: 'Petri' },
      { en: 'Babylon', bs: 'Babilonu' },
      { en: 'Knossos', bs: 'Knososu' },
    ],
    correctIndex: 3,
  },
  {
  ...
  },
  {
    ...
    options: [
      { en: 'Medieval heraldry', bs: 'Srednjovjekovne heraldike' },
      { en: 'Naval ship design', bs: 'Dizajna ratnih brodova' },
      { en: 'Suicide rates', bs: 'Stope samoubistva' },
      { en: 'Alpine farming tools', bs: 'Alpskih poljoprivrednih alata' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: "Eratosthenes estimated Earth's circumference using…",
      bs: 'Eratosthenes je procijenio obim Zemlje koristeći…',
    },
    options: [
      { en: 'Lunar eclipses only', bs: 'Samo mjesečeve pomrčine' },
      { en: 'Magnetic declination', bs: 'Magnetnu deklanaciju' },
      { en: 'Tidal charts', bs: 'Plimske karte' },
      { en: 'Shadow angles at Syene and Alexandria', bs: 'Uglove sjena u Syene i Aleksandriji' },
    ],
    correctIndex: 3,
  },
  {
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: 'Ibn Sina compiled the medical encyclopedia…',
      bs: 'Ibn Sina je sastavio medicinsku enciklopediju…',
    },
    options: [
      { en: "Gray's Anatomy", bs: "Gray's Anatomy" },
      { en: 'Canon of Medicine', bs: 'Canon of Medicine' },
      { en: 'De humani corporis fabrica', bs: 'De humani corporis fabrica' },
      { en: 'Principia Mathematica', bs: 'Principia Mathematica' },
    ],
    correctIndex: 1,
  ...
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      en: "Henrietta Lacks's cells became the widely used laboratory line…",
      bs: 'Henrietta Lacks-ine ćelije postale su široko korištena laboratorijska linija…',
    },
    options: [
      { en: 'Jurkat', bs: 'Jurkat' },
      { en: 'CHO', bs: 'CHO' },
