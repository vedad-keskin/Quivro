...
export const islamEasy: Question[] = [
  ...
  },
  {
    ...
    category: 'islam',
    difficulty: 'easy',
    prompt: { en: 'The hadith about rights teaches balance among Allah, yourself, and:', bs: 'Hadis o pravima uči ravnoteži između Allaha, sebe i:' },
    options: [
  ...
  },
  {
    ...
    category: 'islam',
    difficulty: 'easy',
    prompt: { en: 'Which pillar of Islam is fasting during Ramadan?', bs: 'Koji stub islama je post u mjesecu ramazanu?' },
    options: [
  ...
  },
  {
    ...
    category: 'islam',
    difficulty: 'easy',
    prompt: { en: 'What does a Muslim testify in the shahada?', bs: 'U šehadetu musliman svjedoči da:' },
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Alcohol, interest, adultery, and gambling', bs: 'Alkohol, riba, blud i kockanje' },
    ],
    correctIndex: 3,
  },
  {
