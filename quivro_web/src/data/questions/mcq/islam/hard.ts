...
export const islamHard: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Dream interpreters only', bs: 'Samo tumača snova' },
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      { en: 'Nose', bs: 'Nosu' },
      { en: 'Foot only', bs: 'Samo stopalu' },
      { en: 'Shoulder only', bs: 'Samo ramenu' },
      { en: 'Tongue only', bs: 'Samo jeziku' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      { en: 'Al-Fatiha only', bs: 'Samo El-Fatiha' },
      { en: 'Al-Waqi\'a, Al-Mursalat, An-Naba, and At-Takwir', bs: 'El-Vakiji, El-Murselat, En-Nebe i Et-Tekviru' },
      { en: 'Al-Kawthar only', bs: 'Samo El-Kevser' },
      { en: 'Al-Ikhlas only', bs: 'Samo El-Ihlas' },
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      ...
      { en: 'Only on fingernails', bs: 'Samo na noktima' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    options: [
      { en: '50 fighters only', bs: 'Samo 50 boraca' },
      { en: '10,000 Roman allies', bs: '10.000 rimskih saveznika' },
      { en: 'No army—only poets', bs: 'Bez vojske—samo pjesnike' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'You need two witnesses only', bs: 'Da trebaju samo dva svjedoka' },
      { en: 'Gold keys are forbidden', bs: 'Da su zlatni ključevi zabranjeni' },
      { en: 'Only scholars may enter', bs: 'Da samo učenjaci ulaze' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      { en: 'Only scholars can avoid sin', bs: 'Samo učenjaci mogu izbjeći grijeh' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Paying money only', bs: 'Samo plaćanjem novca' },
  ...
  },
  {
    ...
    options: [
      { en: 'It only affects non-Muslims', bs: 'Pogađa samo nemuslimane' },
      { en: 'It cancels zakat only', bs: 'Poništava samo zekat' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'None—only his own', bs: 'Nijednu—samo svoju' },
    ],
    correctIndex: 0,
  },
  {
    ...
    options: [
      ...
      { en: 'Hajj stones only', bs: 'Samo hadž kamenja' },
  ...
  },
  {
    ...
    options: [
      { en: 'Affirming worship for Allah alone', bs: 'Potvrđivanje ibadeta samo Allahu' },
  ...
  },
  {
    ...
    category: 'islam',
    difficulty: 'hard',
    prompt: { en: 'A common error is thinking prophets were sent mainly to establish rububiyya alone; the Quraysh already accepted Allah as:', bs: 'Česta greška je misliti da su poslanici slani samo za rububijjet; Kurejši su već priznavali Allaha kao:' },
    options: [
      { en: 'Only a tribal spirit', bs: 'Samo plemenski duh' },
  ...
  },
  {
    ...
    options: [
      { en: 'Jibril only for all records', bs: 'Samo Džibril za sve zapise' },
      { en: 'Mikail only', bs: 'Samo Mikail' },
      { en: 'Israfil only', bs: 'Samo Israfil' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Bringing rain only', bs: 'Samo donošenjem kiše' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'The year date only', bs: 'Samo godina' },
  ...
  },
  {
    ...
    options: [
      { en: 'Roman trade routes only', bs: 'Samo rimskih trgovačkih ruta' },
  ...
  },
  {
    ...
    options: [
      { en: 'Al-Baqarah only', bs: 'Samo El-Bekara' },
      { en: 'Al-Ikhlas only', bs: 'Samo El-Ihlas' },
      { en: 'At-Tawbah only', bs: 'Samo Et-Tevbe' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only the Prophet alone', bs: 'Samo Poslanika' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Roman physicians only', bs: 'Samo rimskih ljekara' },
  ...
  },
  {
    ...
    options: [
      { en: 'Ten only, unchanged', bs: 'Samo deset, nepromijenjeno' },
      { en: 'Fifty, then reduced to five with reward of fifty', bs: 'Pedeset, zatim smanjeno na pet s nagradom pedeset' },
      { en: 'Two only', bs: 'Samo dva' },
      { en: 'None—added later in Medina only by companions', bs: 'Nijedan—dodali ashabi kasnije' },
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Three hours only', bs: 'Samo tri sata' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Writing the Qur\'an alone', bs: 'Samostalno pisanje Kur\'ana' },
      { en: 'Conquering Mecca alone', bs: 'Samostalno osvajanje Meke' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Badr only', bs: 'Samo Bederu' },
      { en: 'Tabuk', bs: 'Tabuku' },
      { en: 'Hunayn only', bs: 'Samo Hunajnu' },
    ],
    correctIndex: 0,
  },
  {
  ...
  },
  {
    ...
    options: [
      { en: 'Al-Muwatta fiqh book only', bs: 'Samo fikh djela El-Muvatta' },
      { en: 'Greek philosophy', bs: 'Grčke filozofije' },
      { en: 'The Musnad hadith collection', bs: 'Hadiske zbirke Musnad' },
      { en: 'The Qur\'an alone without hadith', bs: 'Samo Kur\'ana bez hadisa' },
    ],
    correctIndex: 2,
  },
  {
    ...
    options: [
      { en: 'Medina only', bs: 'Samo Medine' },
      { en: 'Cairo only', bs: 'Samo Kaira' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'The four Sunan only', bs: 'Samo četiri Sunen' },
  ...
  },
  {
    ...
    options: [
      { en: 'Malik only as sixth', bs: 'Samo Malika kao šestog' },
      { en: 'Ibn Majah', bs: 'Ibn Madžu' },
      { en: 'Ahmad only', bs: 'Samo Ahmeda' },
      { en: 'Tabari only', bs: 'Samo Taberija' },
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      { en: 'A tabi\'i only', bs: 'Samo tabina' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'The Prophet only', bs: 'Samo Poslaniku' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only from tabi\'in with no companions', bs: 'Samo od tabina bez ashaba' },
    ],
    correctIndex: 2,
  },
  {
    ...
    options: [
      ...
      { en: 'Mandatory for creed alone', bs: 'Obavezan samo za akidu' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only in dreams', bs: 'Samo u snovima' },
  ...
  },
  {
    ...
    options: [
      { en: 'Only Arabs could narrate', bs: 'Samo Arapi mogu prenositi' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Mixed with perfume only', bs: 'Samo pomiješana s parfemom' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only for drinking', bs: 'Samo za piće' },
  ...
  },
  {
    ...
    options: [
      { en: 'One hour only', bs: 'Samo jednog sata' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only Surah Al-Fatiha', bs: 'Samo suru El-Fatiha' },
      { en: 'The word Allah only', bs: 'Samo riječ Allah' },
  ...
  },
  {
    ...
    options: [
      { en: 'No ruku\' or sujud—standing supplications only', bs: 'Nema rukua ni sedžde—samo dova stojeći' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Only debts, not assets', bs: 'Samo dugove, ne imovinu' },
    ],
    correctIndex: 1,
  },
  {
    ...
    options: [
      ...
      { en: 'Only non-Muslim heirs', bs: 'Samo nemuslimanske nasljednike' },
    ],
    correctIndex: 2,
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Distant cousin only', bs: 'Samo dalekog rođaka' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Owned by rulers only', bs: 'U vlasništvu samo vladara' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Abu Jahl\'s sons only', bs: 'Samo sinova Ebu Jehla' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Commander of Badr only', bs: 'Samo komandant Bederа' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Translations into English only', bs: 'Samo prijevodi na engleski' },
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Seven copies by Uthman only', bs: 'Samo sedam Osmanovih primjeraka' },
