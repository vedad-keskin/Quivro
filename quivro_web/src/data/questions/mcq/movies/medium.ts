...
export const moviesMedium: Question[] = [
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'In Avatar, what rare mineral are humans mining on Pandora?', bs: 'U Avataru, koji rijetki mineral ljudi vađe na Pandori?' },
    options: [
      { en: 'Gold', bs: 'Zlato' },
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'At which platform do students catch the Hogwarts Express?', bs: 'Na kojem peronu učenici hvataju Hogwarts Express?' },
    options: [
      { en: 'Platform 7', bs: 'Peron 7' },
      { en: 'Platform 9¾', bs: 'Peron 9¾' },
      { en: 'Platform 10', bs: 'Peron 10' },
      { en: 'Platform 12', bs: 'Peron 12' },
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'In Dune (2021), the desert planet Paul Atreides visits is called…', bs: 'U Dune (2021), pustinjska planeta koju Paul Atreides posjećuje zove se…' },
    options: [
      { en: 'Tatooine', bs: 'Tatooine' },
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'In Black Mirror, most episodes are…', bs: 'U Black Mirror, većina epizoda su…' },
    options: [
      { en: 'Live sports broadcasts', bs: 'Sportski prenosi uživo' },
      { en: 'Standalone sci-fi stories', bs: 'Samostalne sci-fi priče' },
      { en: 'Cooking competitions', bs: 'Kulinarska takmičenja' },
      { en: 'Reality dating shows', bs: 'Reality dating emisije' },
    ],
    correctIndex: 1,
  },
  {
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'At the end of Shrek, Fiona becomes an…', bs: 'Na kraju Shreka, Fiona postane…' },
    options: [
      { en: 'Princess forever', bs: 'Princeza zauvijek' },
      { en: 'Ogre', bs: 'Ogarica' },
      { en: 'Dragon', bs: 'Zmajica' },
      { en: 'Fairy', bs: 'Vila' },
    ],
    correctIndex: 1,
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'In How to Train Your Dragon, Hiccup’s dragon is named…', bs: 'U Kako izdresirati svog zmaja, Hiccupov zmaj se zove…' },
    options: [
      { en: 'Toothless', bs: 'Toothless' },
      { en: 'Smaug', bs: 'Smaug' },
      { en: 'Drogon', bs: 'Drogon' },
  ...
  },
  {
    ...
    category: 'movies',
    difficulty: 'medium',
    prompt: { en: 'Who is the main panda hero in Kung Fu Panda?', bs: 'Ko je glavni panda heroj u Kung Fu Panda?' },
    options: [
